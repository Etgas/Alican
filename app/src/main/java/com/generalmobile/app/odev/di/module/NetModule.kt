...
import com.generalmobile.app.odev.service.ApiClient
...
class NetModule {
    ...
    @Singleton
    @Provides
    fun provideService(retrofit: Retrofit.Builder):odevApi{

        return retrofit.baseUrl(ApiClient.BASE_URL)
                .build()
                .create(odevApi::class.java)
    }
